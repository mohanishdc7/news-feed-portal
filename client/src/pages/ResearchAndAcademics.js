...
function ResearchAndAcademices() {
  ...
  useEffect(() => {
    setIsLoading(true);
    fetch(
      // "./news.db/research-academics.json"
      ...
      .then((data) => {
        ...
        for (const key in data) {
          ...
          if (newsItem.category === "research-academics") news.push(newsItem);
        }
...
export default ResearchAndAcademices;
